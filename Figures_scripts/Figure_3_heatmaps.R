...
IFNplotheatmap <- function(soft,peaks,dataset){
  ...
  # plotHeatmap(sumlist[[2]],nbtiles,dim(peaksFCup)[1],100,colors,main="CD8 T cells")
  # plotHeatmap(sumlist[[1]],nbtiles,dim(peaksFCup)[1],100,colors,main="Naive")
...
RAplotheatmap("DB_pp",K4_DB,"RA_H3K4me3") #reverse positive and negative
